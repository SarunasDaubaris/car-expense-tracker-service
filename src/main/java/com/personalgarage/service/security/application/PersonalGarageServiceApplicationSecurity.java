...
@EnableWebSecurity
public class PersonalGarageServiceApplicationSecurity extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public PersonalGarageServiceApplicationSecurity(UserDetailsService userDetailsService) {
